  ...
  return (
    <main className="bg-green-100 min-h-screen p-12">
      <section className="container mx-auto">
        <h1 className="text-5xl flex justify-center cursive">Meus Projetos</h1>
        <h2 className="text-lg text-gray-600 flex justify-center mb-12">Bem-vindo à minha página de projetos</h2>
          ...
          {projectData && projectData.map((project, index) => (
            <article className="relative rounded-lg shadow-xl bg-white p-16" key={index}>
              ...
              <div className="text-gray-500 text-xs space-x-4">
                ...
                <span>
                  <strong className="font-bold">Empresa</strong>: {project.place}
                </span>
                <span>
